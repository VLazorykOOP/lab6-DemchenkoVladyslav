...
namespace SpaceExample1 {
	...
	class D112 : protected D12, protected D1
	{
	protected:
		double dt;
	public:
	...
	class D112V3 : virtual protected D12VV, virtual public D1V
	{
	protected:
		double dt;
	public:
		D112V3() : dt(1) {}
		D112V3(int d) : dt(d) {}
		D112V3(int a, int b, int c, double d, int e) : D12VV(a, b, c, d, e), D1V::D1V(a + 1),
			dt(e + 1.0) {}
		void showDat()
		{
	...
	{
		std::cout << " Example1  \n";
		D112 a, b(1, 2, 3, 4.5, 5);
		D112V3 av, bv(1, 2, 3, 4.5, 5);
		...
		std::cout << "Size for D112 " << sizeof(D112) << std::endl;
		...
		std::cout << "Size for D112V3 " << sizeof(D112V3) << std::endl;

		std::cout << "Size for object class D112 " << sizeof(D112) << " or  "
			<< sizeof(a) << " or  " << sizeof(b) << std::endl;
		std::cout << "Size for object class D112V3 " << sizeof(D112V3) << " or  "
